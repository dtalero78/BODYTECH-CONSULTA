        ...
        <div className="mt-3.5 flex items-center justify-between pt-3.5 border-t border-dashed border-[var(--p-line)]">
          ...
          {onEdit && (
            <button
              ...
              className="ml-3 inline-flex items-center gap-1.5 px-3.5 py-2 rounded-[10px] text-xs font-semibold bg-[var(--p-accent)] text-[var(--p-on-accent)] hover:bg-[var(--p-accent-hover)] transition"
            >
              <Pencil size={13} />
              {actionLabel ?? 'Editar'}
            </button>
