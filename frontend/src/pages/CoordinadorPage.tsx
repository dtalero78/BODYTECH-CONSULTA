...
import { ProfesionalFormModal } from '../components/coordinador/ProfesionalFormModal';
import { DisponibilidadModal } from '../components/coordinador/DisponibilidadModal';
...
export function CoordinadorPage() {
  ...
  }, [filterRol, filterActivo, search, navigate]);
  ...
  async function confirmDeleteProfesional() {
    ...
    try {
      ...
      showToast({ type: 'success', message: `${nombreCompleto(confirmDelete)} fue desactivado.` });
      ...
      {confirmDelete && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl max-w-sm w-full p-6">
            <h3 className="text-base font-semibold text-gray-800 mb-2">Desactivar profesional</h3>
            <p className="text-sm text-gray-600 mb-5">
              ¿Estás seguro de desactivar a{' '}
              <strong>{nombreCompleto(confirmDelete)}</strong>? No se borrará del sistema, solo
              dejará de aparecer en listas activas y no podrá recibir nuevas citas.
            </p>
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1.5 mb-4">
        ...
        {!profesional.activo && (
          <p className="text-xs font-medium text-red-600">Inactivo</p>
        )}
      </div>
