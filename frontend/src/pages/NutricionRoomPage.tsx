 ...
 *
 * Espejo de DoctorRoomPage pero renderiza el panel nutricional clásico
 * (MedicalHistoryPanel: somatocarta, antropometría ISAK, somatotipo Heath-Carter,
 * plan nutricional con IA) en lugar del panel de consulta de 7 tabs.
 *
 * URL: /nutricion/:roomName?doctor=CODE&documento=HISTORIA_ID&paciente=NOMBRE
 */
export const NutricionRoomPage = () => {
    ...
    <div className="min-h-screen bg-[#0b141a] flex items-center justify-center p-4">
      <div className="bg-[#1f2c34] rounded-3xl shadow-2xl p-8 sm:p-10 max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm">Panel Nutricional</p>
        </div>
